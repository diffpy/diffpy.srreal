...
project = u'SrReal'
copyright = u'2013, Pavol Juhas, Christopher Farrow'
...
latex_documents = [
  ('index', 'SrReal.tex', u'SrReal Documentation',
   u'Pavol Juhas, Christopher Farrow', 'manual'),
]
...
man_pages = [
    ('index', 'srreal', u'SrReal Documentation',
     [u'Pavol Juhas, Christopher Farrow'], 1)
]
...
texinfo_documents = [
  ('index', 'SrReal', u'SrReal Documentation',
   u'Pavol Juhas, Christopher Farrow', 'SrReal', 'One line description of project.',
   'Miscellaneous'),
]
